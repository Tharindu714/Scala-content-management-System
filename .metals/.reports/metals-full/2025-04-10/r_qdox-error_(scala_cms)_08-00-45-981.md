error id: file:///E:/Scala/Scala_CMS/src/main/java/com/scalatutorial/model/Content.java
...
text:
```scala
p@@ackage com.scalatutorial.model
...
QDox parse error in file:///E:/Scala/Scala_CMS/src/main/java/com/scalatutorial/model/Content.java